...
print("Adding data to data source...")
for file in __update_data__[1]['new']:
    print("\tAdding data to %s... " % file, end='')
    test_utils.__store_data(file=file,
                             data=__update_data__[1]["new"][file],
                             extension=extension)
    print("OK")

print("Finished adding data to data to source.")

print("Removing data from data source...")
for file in __update_data__[1]['removed']:
    print("\tRemoving data from %s... " % file, end='')
    test_utils.__remove_data(file=file,
                             data=__update_data__[1]["removed"][file],
                             extension=extension)
    print("OK")

print("Finished removing data from data to source.")

print("Updating triples...")
...
print("Updated triples in %.2fs" % (end-start))
