__test__ = "gtfs-bench-csv-morph-memory-no-inc"
__mapping_file__ = "mapping_memory.csv.ttl"
...
sources = ["data/STOP_TIMES.csv", "data/TRIPS.csv", "data/ROUTES.csv", "data/AGENCY.csv", "data/STOPS.csv", "data/CALENDAR.csv", "data/CALENDAR_DATES.csv", "data/FEED_INFO.csv", "data/SHAPES.csv", "data/FREQUENCIES.csv"]
data_source = {}

for source in sources:
    data_source[source] = pd.read_csv(source, dtype=str)
...
g = morph_kgc.materialize(config=config, python_source=data_source)
end = time.time()
